...
<body>
  ...
  <p class="soustitre">Bienvenue sur "po23a", l'application des anniversaires de mariage</p>
  <?php include "menu.php"; ?>

  <?php
    $collection = [];
    $n1 = new Noces(10, "Étain");
    array_push($collection, $n1);
    $n2 = new Noces(20, "Porcelaine");
    array_push($collection, $n2);
    $n3 = new Noces(30, "Perle");
    array_push($collection, $n3);
    $n4 = new Noces(40, "Émeraude");
